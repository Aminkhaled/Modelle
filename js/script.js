...
$(document).ready(function () {
    ...
    $('.items .item-product-5').hover(function () {
        $('.items .item-product-5 .item-hover').show();
        $('.items .item-product-5 .item-text hr').css({
            top: 55 + '%'
        });
        $('.items .item-product-6 .item-text hr').css({
            top: 75 + '%'
        });
        $('.items .item-product-7 .item-text hr').css({
            top: 75 + '%'
        });
        $('.items .item-product-8 .item-text hr').css({
            top: 75 + '%'
        });
    }, function () {
        $('.items .item-product-5 .item-hover').hide();
        $('.items .item-product-5 .item-text hr').css({
            top: 69 + '%'
        });
        $('.items .item-product-6 .item-text hr').css({
    ...
    $('.items .item-product-6').hover(function () {
        $('.items .item-product-6 .item-hover').show();
        $('.items .item-product-6 .item-text hr').css({
            top: 55 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
        ...
        $('.items .item-product-6 .item-hover').hide();
        $('.items .item-product-6 .item-text hr').css({
            top: 69 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
    ...
    $('.items .item-product-7').hover(function () {
        $('.items .item-product-7 .item-hover').show();
        $('.items .item-product-7 .item-text hr').css({
            top: 55 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
        ...
        $('.items .item-product-7 .item-hover').hide();
        $('.items .item-product-7 .item-text hr').css({
            top: 69 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
    ...
    $('.items .item-product-8').hover(function () {
        $('.items .item-product-8 .item-hover').show();
        $('.items .item-product-8 .item-text hr').css({
            top: 55 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
        ...
        $('.items .item-product-8 .item-hover').hide();
        $('.items .item-product-8 .item-text hr').css({
            top: 69 + '%'
        });
        $('.items .item-product-5 .item-text hr').css({
